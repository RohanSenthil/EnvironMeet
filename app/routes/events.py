...
def add_events():
    ...
    if request.method == "POST" and form.validate():
        event = Events(organiser=form.organiser.data, name=form.name.data, date=form.date.data, price=form.price.data, points=form.points.data, image=form.image.data)
